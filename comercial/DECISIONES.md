...
| 2026-08-24 | Establecer inicialmente WhatsApp, email e Instagram como canales propios | Crear una infraestructura comercial mínima y controlable | Vigente |
...
| 2026-08-25 | Consolidar la estrategia comercial y el plan de contenido en `docs/estrategia-comercial-copiloto-v1.md` y `docs/plan-contenido-100-dias-v1.md`, eliminando las versiones previas | Evitar dos fuentes de verdad para el mismo tema | Vigente |

## Criterio

Este archivo funciona como índice de decisiones. Las decisiones relevantes deben documentarse aquí o en archivos específicos dentro de `comercial/`.

Las ideas e hipótesis no se consideran decisiones definitivas hasta contar con validación o aprobación explícita.
